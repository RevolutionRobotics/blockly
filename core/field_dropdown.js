...
Blockly.FieldDropdown.prototype.showPopup_ = function(fieldDropdown) {
...
Blockly.FieldDropdown.prototype.showInlineDropdown_ = function(opt_e) {
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function (imageJson) {
  ...
  var arrowWidth = 2; // Blockly.utils.dom.getTextWidth(this.arrow_);
